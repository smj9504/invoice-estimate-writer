"""
Invoice repository implementations for different database providers.
"""
...
from app.models.sqlalchemy_models import Invoice, InvoiceItem
...
def get_invoice_repository(session: DatabaseSession) -> InvoiceRepositoryMixin:
    ...
    if hasattr(session, 'query'):
        # SQLAlchemy session
        return InvoiceSQLAlchemyRepository(session)
    else:
        # Assume Supabase client
        return InvoiceSupabaseRepository(session)